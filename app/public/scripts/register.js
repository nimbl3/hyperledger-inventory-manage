...
//check user input and call server to create dataset
$('.register-manager').click(function() {
  ...
  //create json data
  var inputData = '{' + '"name" : "' + formName + '", ' + '"managerid" : "' + formPartnerId + '", ' + '"cardid" : "' + formCardId + '", ' + '"email" : "' + formEmail + '", ' + '"phonenumber" : "' + formPhoneNumber + '"}';
  console.log(inputData)

  //make ajax call to add the dataset
  $.ajax({
    type: 'POST',
    url: apiUrl + 'registerManager',
    data: inputData,
    dataType: 'json',
    contentType: 'application/json',
    beforeSend: function() {
...
$('.register-shipper').click(function() {
  ...
  //create json data
  var inputData = '{' + '"name" : "' + formName + '", ' + '"shipperid" : "' + formShipperId + '", ' + '"cardid" : "' + formCardId + '"}';
  console.log(inputData)

  //make ajax call to add the dataset
  $.ajax({
    type: 'POST',
    url: apiUrl + 'registerShipper',
    data: inputData,
    dataType: 'json',
    contentType: 'application/json',
    beforeSend: function() {
